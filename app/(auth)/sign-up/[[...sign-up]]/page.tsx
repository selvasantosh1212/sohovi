  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <p className="text-white/60 text-sm">Start profiling your data in minutes</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-white/50 max-w-xs">
        Your files never leave your browser. We only store DQ scores and metadata.
      </p>
    </div>
  );
}
