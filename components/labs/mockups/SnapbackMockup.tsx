...
export function SnapbackMockup() {
  return (
    <HeroMockupCard
      header={
        <>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <Database style={{ width: "16px", height: "16px", color: "#1A1A2E" }} />
            <span style={{ ...mono, fontSize: "13px", fontWeight: 500, color: "#1A1A2E" }}>production-db</span>
            <span
              style={{
                display: "inline-flex",
                alignItems: "center",
          ...
          <span style={{ fontSize: "12px", color: "#64748B" }}>Next backup in 6h 12m</span>
        </>
      }
      footer={
        <>
          <span style={{ fontSize: "12px", color: "#64748B" }}>Daily at 04:00 UTC · keeping last 14 backups</span>
    ...
    >
      ...
      <div style={{ padding: "8px 18px" }}>
        <MockupRow delay="0.1s">
          ...
          <span style={{ ...mono, fontSize: "12.5px", color: "#475569" }}>Today 04:00</span>
          <span style={{ fontSize: "12.5px", color: "#64748B", flex: 1 }}>
            218 MB → <span style={mono}>s3://acme-backups</span>
          </span>
          <span style={{ fontSize: "12px", color: "#94A3B8" }}>42s</span>
        </MockupRow>
        <MockupRow delay="0.2s">
          <CheckCircle2 style={{ width: "16px", height: "16px", color: "#10B981", flexShrink: 0 }} />
          <span style={{ ...mono, fontSize: "12.5px", color: "#475569" }}>Yesterday 04:00</span>
          <span style={{ fontSize: "12.5px", color: "#64748B", flex: 1 }}>
            216 MB → <span style={mono}>s3://acme-backups</span>
          </span>
          <span style={{ fontSize: "12px", color: "#94A3B8" }}>40s</span>
        </MockupRow>
        <MockupRow delay="0.3s" noBorder>
          <AlertTriangle style={{ width: "16px", height: "16px", color: "#F59E0B", flexShrink: 0 }} />
          <span style={{ ...mono, fontSize: "12.5px", color: "#475569" }}>Mon 04:00</span>
          <span style={{ fontSize: "12.5px", color: "#64748B", flex: 1 }}>Timeout — retried, succeeded 04:07</span>
          <span
            style={{
              fontSize: "11px",
              fontWeight: 600,
