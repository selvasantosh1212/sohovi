...
export const GUIDE_CATEGORIES: GuideCategory[] = [
  ...
  },
  {
    ...
    guides: [
      ...
      {
        id: "create-workflow",
        title: "Save Rules as a Reusable Workflow",
        summary: "Turn DQ rules you already wrote on one asset into a named, reusable Workflow you can apply to any other asset — no rebuilding from scratch.",
        icon: "Workflow",
        duration: "3 min",
        steps: [
          { step: 1, action: "Open a Data Asset's Rules page where you've already built some rules." },
          { step: 2, action: "Check the boxes next to the rules you want to reuse." },
          { step: 3, action: 'Click "Save as Workflow" in the selection bar that appears.' },
          { step: 4, action: "Create a new workflow (name it, e.g. 'Customer Master DQ') or add to an existing one." },
          { step: 5, action: "Done — the selected rules are snapshotted into the workflow, unaffected by future edits to the originals." },
        ],
        example: "Example: Workflow 'Customer Master DQ' bundles: customer_id → uniqueness; email → validity format; created_at → timeliness freshness_check.",
        tip: "Workflows save time when you want the same checks (email validity, completeness, etc.) on more than one asset — e.g. Customer Master and Customer Master EU.",
        videoRef: 6,
      },
      {
        id: "apply-workflow",
        title: "Apply a Workflow to an Asset",
        summary: "Materialize a saved workflow's rules onto any data asset, mapping columns along the way.",
        icon: "Zap",
        duration: "2 min",
        steps: [
          { step: 1, action: 'In the sidebar, click "Workflows" and open the one you want.' },
          { step: 2, action: 'Click "Apply to Asset".' },
          { step: 3, action: "Pick the target asset — the same one it came from, or a different one entirely." },
          { step: 4, action: "Map the workflow's columns to that asset's real columns (exact-name matches are pre-filled)." },
          { step: 5, action: "Review the preview, then confirm — new rules appear on that asset's Rules page immediately." },
        ],
        tip: "Applying the same workflow twice to the same asset safely skips rules that already exist there — you'll see exactly what was skipped and why.",
        videoRef: 6,
      },
      {
        id: "remediation",
